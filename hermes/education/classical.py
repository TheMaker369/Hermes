...
class ClassicalEducation:
    ...
    def process_input(self, data: Dict[str, Any], 
    ...
    def _apply_quadrivium(self, data: Dict[str, Any], 
    ...
    def _determine_relevant_subjects(self, 
                                   context: Dict[str, Any]) -> List[QuadriviumSubject]:
    ...
    def get_education_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'sacred_pattern': self.trivium_mapping[self.current_trivium]['sacred_pattern'],
